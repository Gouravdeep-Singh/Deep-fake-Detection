...
3. Compile the Model: Compile the both the model by specifying the loss function, optimizer, and evaluation metrics.
...
> It is noticable that even though the pre-trained model has less accuracy even below 50% yet it provides the right output was well as in less time compared to our model
